...
{
    public class ManagerLonglistVacancyRepository : IManagerLonglistIVacancyRepository
    {
        private readonly AppDbContext _context;

        public ManagerLonglistVacancyRepository(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<Vacancy?> GetVacancyByJobIdAsync(Guid jobId)
        {
            return await _context.Vacancies
                .Include(v => v.JobRole)
                .FirstOrDefaultAsync(v => v.JobRole.JobId == jobId);
        }
    }
}